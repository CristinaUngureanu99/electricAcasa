          ...
          {emailSent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-500 text-sm">
                ...
                <span className="font-semibold text-navy">{email}</span>. Accesează linkul din email
                pentru a-ți activa contul.
              </p>
              <Link
                href="/login"
                className="inline-block text-accent font-semibold hover:underline text-sm mt-2"
              >
