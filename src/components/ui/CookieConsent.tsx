...
export default function CookieConsent() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 animate-slide-up"
    >
      <div className="max-w-5xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 relative">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="shimmer-btn px-6 py-2.5 text-white text-sm font-semibold rounded-full transition-all shadow-lg shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 whitespace-nowrap"
          >
            Acceptă
          </button>
          <button
